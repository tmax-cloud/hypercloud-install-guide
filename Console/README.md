...
## 구성 요소 및 버전
* hypercloud-console([tmaxcloudck/hypercloud-console:latest](https://hub.docker.com/r/tmaxcloudck/hypercloud-console/tags))
...
* 생성 순서 : 
    ...
    * 작업 폴더로 이동하고, `kubectl create secret tls console-https-secret --cert=./tls/tls.crt --key=./tls/tls.key -n console-system(혹은 다른 namespace)` 을 실행합니다.
