...
sed -i "s/image: gcr.io\/ml-pipeline\/api-server/image: ${registry}\/gcr.io\/ml-pipeline\/api-server/g" ${dir}/api-service/base/deployment.yaml
sed -i "s/image: gcr.io\/kubeflow-images-public\/kubernetes-sigs\/application/image: ${registry}\/cr.io\/kubeflow-images-public\/kubernetes-sigs\/application/g" ${dir}/application/base/stateful-set.yaml
...
sed -i "s/image: gcr.io\/kubeflow-images-public\/centraldashboard/image: ${registry}\/gcr.io\/kubeflow-images-public\/centraldashboard/g" ${dir}/centraldashboard/base/deployment.yaml
...
sed -i "s/image: gcr.io\/kubeflow-images-public\/jupyter-web-app/image: ${registry}\/gcr.io\/kubeflow-images-public\/jupyter-web-app/g" ${dir}/jupyter-web-app\/base\/deployment.yaml
...
sed -i "s/image: gcr.io\/kubeflow-images-public\/katib\/v1alpha3\/katib-controller/image: ${registry}\/gcr.io\/kubeflow-images-public\/katib\/v1alpha3\/katib-controller/g" ${dir}/katib-controller\/base\/katib-controller-deployment.yaml
sed -i "s/image: gcr.io\/kubeflow-images-public\/katib\/v1alpha3\/katib-db-manager/image: ${registry}\/gcr.io\/kubeflow-images-public\/katib\/v1alpha3\/katib-db-manager/g" ${dir}/katib-controller\/base\/katib-db-manager-deployment.yaml
...
sed -i "s/image: gcr.io\/knative-releases\/knative.dev\/serving\/cmd/image: ${registry}\/gcr.io\/knative-releases\/knative.dev\/serving\/cmd/g" ${dir}/knative-install/base/deployment.yaml
...
sed -i "s/image: gcr.io\/ml-pipeline\/visualization-server/image: ${registry}\/gcr.io\/ml-pipeline\/visualization-server/g" ${dir}/pipeline-visualization-service\/base\/deployment.yaml
sed -i "s/image: gcr.io\/kubeflow-images-public\/profile-controller/image: ${registry}\/gcr.io\/kubeflow-images-public\/profile-controller/g" ${dir}/profiles\/base\/deployment.yaml
sed -i "s/image: gcr.io\/kubeflow-images-public\/kfam/image: ${registry}\/gcr.io\/kubeflow-images-public\/kfam/g" ${dir}/profiles\/base\/deployment.yaml
...
sed -i "s/image: gcr.io\/kubeflow-images-public\/tf_operator/image: ${registry}\/gcr.io\/kubeflow-images-public\/tf_operator/g" ${dir}/tf-job-operator\/base\/deployment.yaml
sed -i "s/image: gcr.io\/kubeflow-images-public\/admission-webhook/image: ${registry}\/gcr.io\/kubeflow-images-public\/admission-webhook/g" ${dir}/webhook\/base\/deployment.yaml
