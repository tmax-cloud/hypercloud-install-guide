...
* prometheus pod에 storage를 마운트하고 싶지 않을 경우, prometheus-prometheus.yaml 에 spec.storage 부분을 삭제 한다.(storage를 마운트 하는 경우 rook-ceph-block stroage class가 설치 되어있어야 한다.)
